...
Require-Text 'src/reload_stages/ReloadStages.cpp' 'RockProviderWeaponSizeClassV1::Pistol[\s\S]*RockProviderWeaponPartKindV1::Magazine[\s\S]*RockProviderWeaponPartKindV1::Slide[\s\S]*PaperReloadStageFlagV1::Rest[\s\S]*PaperReloadStageFlagV1::Fire[\s\S]*PaperReloadStageFlagV1::SlideBack[\s\S]*PaperReloadStageFlagV1::MagazineIn[\s\S]*PaperReloadStageFlagV1::MagazineOut' 'The derived stage layer must remain pistol-scoped and publish all five independent requested signals.'
Require-Text 'src/reload_stages/ReloadStages.cpp' 'allGroupMembersMatch\([\s\S]{0,180}aggregatePartCount[\s\S]{0,600}allGroupMembersMatch\([\s\S]{0,180}slidePartCount[\s\S]{0,600}allGroupMembersMatch\([\s\S]{0,180}magazinePartCount[\s\S]{0,600}allGroupMembersMatch\([\s\S]{0,180}magazinePartCount' 'Rest, slide, and magazine aggregate stages must require every member of their deduplicated group to match.'
