...
Require-Text 'src/PaperMain.cpp' 'refreshEnrichmentDemand[\s\S]*ReloadAnimationEvidence[\s\S]*ReloadAnimationTelemetry[\s\S]*ReloadObservations[\s\S]*ReloadEvidenceGeometry[\s\S]*enrichmentDemand\.reloadObservation[\s\S]*enrichmentDemand\.animationTelemetry[\s\S]*enrichmentDemand\.exactAnimationEvidence' 'Reload observation, passive animation telemetry, and exact evidence demand must remain independently capability-gated.'
